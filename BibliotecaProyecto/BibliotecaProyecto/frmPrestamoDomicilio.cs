...
{
    public partial class frmPrestamoDomicilio : Form
    {
        public frmPrestamoDomicilio()
        {
            InitializeComponent();
        }
        ...
        private void frmPrestamoDomicilio_Load(object sender, EventArgs e)
        {
        ...
        {
            frmPrestamos frmpre = new frmPrestamos(fechaDevolucionTextBox.Text);
            this.Hide();
        }
    }
}
